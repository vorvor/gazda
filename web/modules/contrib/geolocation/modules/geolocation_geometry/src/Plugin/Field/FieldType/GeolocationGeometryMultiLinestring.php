...
#[FieldType(
  ...
  label: new \Drupal\Core\StringTranslation\TranslatableMarkup('Geolocation Geometry - MultiLine'),
  description: new \Drupal\Core\StringTranslation\TranslatableMarkup("This field stores spatial geometry of type 'MultiLineString'."),
