...
use Drupal\visitors\Plugin\views\field\VisitorsFlash;
 ...
 *
 * @group visitors
 * @coversDefaultClass \Drupal\visitors\Plugin\views\field\VisitorsBrowserPlugin
 * @uses \Drupal\visitors\Plugin\views\field\VisitorsBrowserPlugin
 */
class VisitorsBrowserPluginTest extends UnitTestCase {

  /**
   * The field.
   *
   * @var \Drupal\visitors\Plugin\views\field\VisitorsBrowserPlugin
   */
  protected $field;
  ...
  protected function setUp(): void {
    ...
    $plugin_definition = [];
    $this->field = VisitorsFlash::create($container, $configuration, $plugin_id, $plugin_definition);
    $options = [];
    $options['id'] = 'id';
    $options['icon'] = TRUE;
  ...
  public function testCreate() {
    ...
    $plugin_id = 'visitors_country';
    $plugin_definition = [];
    $field = VisitorsFlash::create($container, $configuration, $plugin_id, $plugin_definition);
    $this->assertInstanceOf('Drupal\visitors\Plugin\views\field\VisitorsFlash', $field);
  }
  ...
  public function testConstruct() {
    $field = new VisitorsFlash([], 'visitors_country', [], $this->moduleHandler, $this->request);
    $this->assertInstanceOf('Drupal\visitors\Plugin\views\field\VisitorsFlash', $field);
  }
  ...
  public function testRender() {
    ...
    $values = new ResultRow(['alias' => '10']);
    $this->field->field_alias = 'alias';

    $this->assertEquals('<img src="/base/path/modules/contrib/visitors/icons/plugins/flash.png" width="16" height="16" />', (string) $this->field->render($values));
  }
   ...
   * @covers ::render
   */
  public function testRenderNoIcon() {

    $values = new ResultRow(['alias' => '10']);
    $this->field->field_alias = 'alias';
    $this->field->options['icon'] = FALSE;

    $this->assertEquals('10', (string) $this->field->render($values));
  }
