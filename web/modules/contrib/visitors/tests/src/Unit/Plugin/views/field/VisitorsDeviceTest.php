...
use Drupal\visitors\Plugin\views\field\VisitorsDevice;
 ...
 *
 * @group visitors
 * @coversDefaultClass \Drupal\visitors\Plugin\views\field\VisitorsDevice
 * @uses \Drupal\visitors\Plugin\views\field\VisitorsDevice
 */
class VisitorsDeviceTest extends UnitTestCase {

  /**
   * The field.
   *
   * @var \Drupal\visitors\Plugin\views\field\VisitorsDevice
   */
  protected $field;
  ...
  protected function setUp(): void {
    ...
    $plugin_definition = [];
    $this->field = VisitorsDevice::create($container, $configuration, $plugin_id, $plugin_definition);
    $options = [];
    $options['id'] = 'id';
    $options['icon'] = TRUE;
  ...
  public function testCreate() {
    ...
    $plugin_id = 'visitors_brand';
    $plugin_definition = [];
    $field = VisitorsDevice::create($container, $configuration, $plugin_id, $plugin_definition);
    $this->assertInstanceOf('Drupal\visitors\Plugin\views\field\VisitorsDevice', $field);
  }
  ...
  public function testConstruct() {
    $field = new VisitorsDevice([], 'visitors_brand', [], $this->moduleHandler, $this->request);
    $this->assertInstanceOf('Drupal\visitors\Plugin\views\field\VisitorsDevice', $field);
  }
  ...
  public function testRender() {
    ...
    $values = new ResultRow(['alias' => 'tablet']);
    $this->field->field_alias = 'alias';

    $this->assertEquals('<img src="/base/path/modules/contrib/visitors/icons/devices/tablet.png" width="16" height="16" /> Tablet', (string) $this->field->render($values));
  }
