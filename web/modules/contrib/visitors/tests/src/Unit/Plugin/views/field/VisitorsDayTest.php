...
use Drupal\visitors\Plugin\views\field\VisitorsDay;
 ...
 *
 * @group visitors
 * @coversDefaultClass \Drupal\visitors\Plugin\views\field\VisitorsDay
 * @covers \Drupal\visitors\Plugin\views\field\VisitorsTimestamp
 */
class VisitorsDayTest extends UnitTestCase {

  /**
   * The field.
   *
   * @var \Drupal\visitors\Plugin\views\field\VisitorsDay
   */
  protected $field;
  ...
  protected function setUp(): void {
    ...
    $plugin_definition = [];
    $this->field = VisitorsDay::create($container, $configuration, $plugin_id, $plugin_definition);
  }
