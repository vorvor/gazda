...
use Drupal\visitors\Plugin\views\field\VisitorsBrowser;
 ...
 *
 * @group visitors
 * @coversDefaultClass \Drupal\visitors\Plugin\views\field\VisitorsBrowser
 * @uses \Drupal\visitors\Plugin\views\field\VisitorsBrowser
 */
class VisitorsBrowserTest extends UnitTestCase {

  /**
   * The field.
   *
   * @var \Drupal\visitors\Plugin\views\field\VisitorsBrowser
   */
  protected $field;
  ...
  protected function setUp(): void {
    ...
    $plugin_definition = [];
    $this->field = VisitorsBrowser::create($container, $configuration, $plugin_id, $plugin_definition);
    $options = [];
    $options['id'] = 'id';
    $options['icon'] = TRUE;
  ...
  public function testCreate() {
    ...
    $plugin_id = 'visitors_country';
    $plugin_definition = [];
    $field = VisitorsBrowser::create($container, $configuration, $plugin_id, $plugin_definition);
    $this->assertInstanceOf('Drupal\visitors\Plugin\views\field\VisitorsBrowser', $field);
  }
  ...
  public function testConstruct() {
    $field = new VisitorsBrowser([], 'visitors_country', [], $this->moduleHandler, $this->request);
    $this->assertInstanceOf('Drupal\visitors\Plugin\views\field\VisitorsBrowser', $field);
  }
  ...
  public function testRender() {
    ...
    $values = new ResultRow(['alias' => 'ie']);
    $this->field->field_alias = 'alias';

    $this->assertEquals('<img src="/base/path/modules/contrib/visitors/icons/browsers/ie.png" width="16" height="16" /> ie', (string) $this->field->render($values));
  }
