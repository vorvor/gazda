...
use Drupal\visitors\Plugin\views\field\VisitorsBrand;
 ...
 *
 * @group visitors
 * @coversDefaultClass \Drupal\visitors\Plugin\views\field\VisitorsBrand
 * @uses \Drupal\visitors\Plugin\views\field\VisitorsBrand
 */
class VisitorsBrandTest extends UnitTestCase {

  /**
   * The field.
   *
   * @var \Drupal\visitors\Plugin\views\field\VisitorsBrand
   */
  protected $field;
  ...
  protected function setUp(): void {
    ...
    $plugin_definition = [];
    $this->field = VisitorsBrand::create($container, $configuration, $plugin_id, $plugin_definition);
    $options = [];
    $options['id'] = 'id';
    $options['icon'] = TRUE;
  ...
  public function testCreate() {
    ...
    $plugin_id = 'visitors_brand';
    $plugin_definition = [];
    $field = VisitorsBrand::create($container, $configuration, $plugin_id, $plugin_definition);
    $this->assertInstanceOf('Drupal\visitors\Plugin\views\field\VisitorsBrand', $field);
  }
  ...
  public function testConstruct() {
    $field = new VisitorsBrand([], 'visitors_brand', [], $this->moduleHandler, $this->request);
    $this->assertInstanceOf('Drupal\visitors\Plugin\views\field\VisitorsBrand', $field);
  }
  ...
  public function testRender() {
    ...
    $values = new ResultRow(['alias' => 'HP']);
    $this->field->field_alias = 'alias';

    $this->assertEquals('<img src="/base/path/modules/contrib/visitors/icons/brand/HP.png" width="16" height="16" /> HP', (string) $this->field->render($values));
  }
