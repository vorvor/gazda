...
/**
 * Tests the hook_update_8227() function.
 *
 * @group visitors
 */
class HookUpdate8227Test extends KernelTestBase {
   ...
   * Tests the hook_update_8227() function.
   */
  public function testHookUpdate8227(): void {

    visitors_update_8227();

    $popular_block = \Drupal::entityTypeManager()
      ->getStorage('block')
      ->load('olivero_popular_content');
    $settings = $popular_block->get('settings');
    $this->assertEquals('node', $settings['entity_type']);
...
YAML;
  ...
  /**
   * Create a legacy visitors_popular_block.
   */
  protected function legacyBlock(): void {
    $yaml = <<<YAML
