...
class __TwigTemplate_fce872a02917cb1d02393c03f88928ed extends Template
{
...
<ol>
  ...
  <li>";
        // line 22
        yield t("On the first field settings page, choose the <em>Comment type</em> to use for this entity type or sub-type. You\x27ll also notice that the <em>Allowed number of values</em> field cannot be changed for comment fields.", array());
        yield "</li>
  <li>";
        // line 23
